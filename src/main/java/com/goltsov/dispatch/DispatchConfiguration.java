...
@Configuration
@ComponentScan(basePackages = {"com.goltsov.dispatch"})
public class DispatchConfiguration {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerContainerFactory(
        ...
        // establish that there will be 3 attempts with an interval of 100 millisecond
    ...
    @Bean
    public ConsumerFactory<String, Object> consumerFactory(@Value("${kafka.bootstrap-servers}")
    ...
    @Bean
    public ProducerFactory<String, Object> producerFactory(@Value("${kafka.bootstrap-servers}")
                                                           String bootstrapServer) {
